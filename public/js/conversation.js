...
var ConversationPanel = (function () {
  ...
  function getDivObject(res, isUser, isTop) {
    ...
    var bot_img = [{'tagName': 'div','classNames': ['segments'],'children':[{'tagName':'p','text':'hola'}]}];
    var messageJson = {
      // <div class='segments'>
      'tagName': 'div',
      'classNames': ['segments'],
    ...
    //logica para crear los elementos del chat
    var div_c=document.createElement("div");
    div_c.classList.add(cadenas);
    ...
    return div_c;
    //fin de logica para crear los elementos del chat
  ...
  function botonEnviar(){
    var inputBox = document.getElementById("ipt-question");
    sendMessage(inputBox.value);
    inputBox.value = '';
    Common.fireEvent(inputBox, 'input');
  }
